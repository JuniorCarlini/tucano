var Tucano = (() => {
  ...
  if (typeof document !== "undefined") {
    ...
    const ready = document.readyState === "complete" || (nav ? nav.domContentLoadedEventStart > 0 : document.readyState !== "loading");
    if (ready) boot();
